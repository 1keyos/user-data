...
resource "local_file" "ca_key" {
  filename = "${var.asset_dir}/${local.tls_dir}/${var.helm_dir_name}/ca.key.pem"
  content  = "${tls_private_key.root.private_key_pem}"
}
*/

resource "local_file" "ca_cert" {
  filename = "${var.asset_dir}/${local.tls_dir}/${var.helm_dir_name}/helm.ca.cert.pem"
...
resource "local_file" "tiller_key" {
  filename = "${var.asset_dir}/${local.tls_dir}/${var.helm_dir_name}/tiller.key.pem"
  content  = "${tls_private_key.tiller_server.private_key_pem}"
}

resource "local_file" "tiller_cert" {
  filename = "${var.asset_dir}/${local.tls_dir}/${var.helm_dir_name}/tiller.cert.pem"
...
resource "local_file" "helm_key" {
  filename = "${var.asset_dir}/${local.tls_dir}/${var.helm_dir_name}/helm_client.key.pem"
  content  = "${tls_private_key.helm_client.private_key_pem}"
}

resource "local_file" "helm_cert" {
  filename = "${var.asset_dir}/${local.tls_dir}/${var.helm_dir_name}/helm_client.cert.pem"
